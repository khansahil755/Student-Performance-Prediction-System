...
def train_decision_tree(X_train, y_train):
    """Train a balanced Decision Tree for comparison."""
...
def train_all(csv_path=None, save=True):
    ...
    logistic_accuracy, logistic_cm, logistic_report = evaluate_model(
        logistic_model,
        X_test_scaled,
        y_test,
        "Logistic Regression",
    ...
    tree_accuracy, tree_cm, tree_report = evaluate_model(
        tree_model,
        X_test,
        y_test,
        "Decision Tree",
    ...
    if save:
        save_model(logistic_model, os.path.join(models_dir, "trained_model.pkl"))
